...
<head>
  ...
  <title>Presensi Siswa | Pulang</title>
...
<body>
  <form action="{{ route('check') }}" method="post">
    ...
    <input type="text" name="kategori" value="pulang">
    @csrf
      ...
      <nav>
        <div class="wrapper">
          ...
          <ul>
            ...
            <li>
              <a href="{{  route('pulang') }}" class="active">PRESENSI PULANG</a>
            </li>
          </ul>
        </div>
      </nav>
      <section>
        <h1>PRESENSI SISWA - <span class="text-select">PULANG</span></h1>
        <img src="{{ asset('./images/illust-presensi-pulang.png') }}" alt="Ilustrasi Presensi">
      </section>
